...
var dir = "app/controller/professor/";
...
function listar() {
    $.get(dir + "listar.php", {}, function (data, status) {
        $(".records_content_professores").html(data);
...
$(document).ready(function () {
    ...
    $('#professores').dataTable();
    $('#professor_modal').on('hide.bs.modal', function (event) {
        $('#professor').bootstrapValidator("resetForm",true);
...
function validar() {
    ...
    return $('#professor').data('bootstrapValidator').isValid();
}
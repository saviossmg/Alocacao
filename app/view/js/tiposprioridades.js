...
function listar() {
    ...
    $.post(dir + "listar.php", {
        ...
        $(".records_content_tiposprioridades").html(data);
        $('#tiposprioridades').dataTable({
...
$(document).ready(function () {
    ...
    $('#tiposprioridades').dataTable();
    $('#prioridade_modal').on('hide.bs.modal', function (event) {
        $('#tipo_prioridade').bootstrapValidator("resetForm",true);
        $('#tipo_prioridade').each(function () {
            this.reset();
            $("#id").val("");
        })
    });
...
function validar() {
    ...
    $('#tipo_prioridade').bootstrapValidator({
    ...
    return $('#tipo_prioridade').data('bootstrapValidator').isValid();
}
...
var dir = "app/controller/equipamento/";
...
function listar() {
    ...
    $.post(dir + "listar.php", {
        ...
        $(".records_content_equipamentos").html(data);
    ...
    $.post(dir + "detalhar.php", {
        ...
        function (data, status) {
            ...
            if(retorno.status){
                ...
                $("#tipoequipamento").val(retorno.data.idpai);
                // abre o modal
                $("#equipamento_modal").modal("show");
            }
            else{
                bootbox.alert(retorno.mensagem);
            }
...
$(document).ready(function () {
    ...
    $('#equipamentos').dataTable();
    $('#equipamento_modal').on('hide.bs.modal', function (event) {
        $('#equipamento').bootstrapValidator("resetForm",true);
...
function validar() {
    ...
    $('#equipamento').bootstrapValidator({
        ...
        fields: {
            ...
            tipoequipamento: {
                validators: {
                    notEmpty: {
                        message: 'O tipo de equipamento é requerido.'
                    }
                }
    ...
    return $('#equipamento').data('bootstrapValidator').isValid();
}
...
function listar() {
    ...
    $.post(dir + "listar.php", {
        ...
        $(".records_content_tiposstatus").html(data);
        $('#tiposstatus').dataTable({
...
$(document).ready(function () {
    ...
    $('#tiposstatus').dataTable();
    $('#tipostatus_modal').on('hide.bs.modal', function (event) {
        $('#tipo_status').bootstrapValidator("resetForm",true);
        $('#tipo_status').each(function () {
            this.reset();
            $("#id").val("");
        })
    });
...
function validar() {
    ...
    $('#tipo_status').bootstrapValidator({
    ...
    return $('#tipo_status').data('bootstrapValidator').isValid();
}